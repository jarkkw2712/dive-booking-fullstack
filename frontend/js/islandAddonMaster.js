...
function islandAddonRowsForEditor(){
  ...
  for(const source of masterRows){
    ...
    else rows.push({item:{id:source.island_addon_id,name:source.island_addon_name,qty:1,price:Number(source.default_price||0),defaultPrice:Number(source.default_price||0),paymentMethod:bookingGroupPaymentSelection.island||bookingDefaultPaymentMethod("island"),source:"island"},savedIndex:-1,selected:false,masterId:source.island_addon_id});
  }
