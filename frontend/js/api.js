...
const API={
  ...
  saveBooking:b=>apiFetch("/bookings",{method:"POST",body:JSON.stringify({...b,boatTicketBookNo:document.getElementById("boatTicketBookNo")?.value||"",boatTicketNo:document.getElementById("boatTicketNo")?.value||""})}),
  updateBooking:(code,b)=>apiFetch(`/bookings/${encodeURIComponent(code)}`,{method:"PUT",body:JSON.stringify({...b,boatTicketBookNo:document.getElementById("boatTicketBookNo")?.value||"",boatTicketNo:document.getElementById("boatTicketNo")?.value||""})}),
