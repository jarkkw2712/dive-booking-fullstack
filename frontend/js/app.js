...
function createPassenger(i=0){const pr=master.programs?.[0]||{program_id:"boat_ticket",program_name:"ตั๋วเรือ",default_price:1500};return{title:i===0?document.getElementById("leaderTitle").value:"",firstName:i===0?document.getElementById("leaderFirstName").value:"",lastName:i===0?document.getElementById("leaderLastName").value:"",age:"",phone:i===0?document.getElementById("phone").value:"",island:"",foodAllergy:"",medicalNote:"",parkAccommodationType:"none",parkAccommodationBookedBy:"customer",parkAccommodationReference:"",parkAccommodationNote:"",isLeader:i===0,program:{programId:pr.program_id,name:pr.program_name,qty:1,price:Number(pr.default_price),defaultPrice:Number(pr.default_price),priceReason:"ราคา Default"},preAddOns:(master.addOns||[]).map(a=>({id:a.addon_id,name:a.addon_name,selected:false,qty:1,price:Number(a.default_price),defaultPrice:Number(a.default_price)})),islandAddOns:[]}}
